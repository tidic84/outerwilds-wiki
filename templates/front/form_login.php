<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
  <div class="sm:mx-auto sm:w-full sm:max-w-sm">
    <h2 class="text-center text-2xl/9 font-bold tracking-tight text-gray-900">Se connecter</h2>
  </div>
    ...
    <form class="space-y-6" action="#" method="POST">
      ...
      <div>
        <div class="flex items-center justify-between">
          ...
          <div class="text-sm">
            <a href="#" class="font-semibold text-orange-600 hover:text-orange-500">Mot de passe oublié ?</a>
          </div>
        </div>
        <div class="mt-2">
