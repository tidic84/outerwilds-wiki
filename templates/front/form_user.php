<form class="w-xl p-5 m-auto mt-30" method="post" action="">
    <div class="space-y-12">
        <div class="border-b border-gray-900/10 pb-12">
            <h2 class="text-base/7 font-semibold text-gray-900">Editeur de profil</h2>
            <p class="mt-1 text-sm/6 text-gray-600">Modifier les informations de l'utilisateur via ce formulaire.</p>
